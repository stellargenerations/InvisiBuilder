        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 space-y-4 mb-6 md:mb-0">
            <h1 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-white">
              <span className="text-primary">Faceless Digital Marketing</span><br/>Without The <span className="text-primary spotlight-text">
                Spotlight
                <div className="spotlight-effect"></div>
              </span>
            </h1>
            <p className="text-base md:text-lg text-neutral-100 max-w-xl">
              Faceless digital marketing, strategies, tools, and insights for building profitable online businesses while staying behind the scenes.
            </p>
