    ...
    <div className="mt-12 mb-2 bg-neutral-900 border-2 border-primary rounded-xl p-6 shadow-lg">
      <div className="flex flex-col md:flex-row items-center gap-6">
        <div className="flex-1">
          <h3 className="text-2xl font-heading font-bold text-primary mb-2">Stay Updated</h3>
        ...
        {isSuccess ? (
          <div className="bg-primary/20 border-2 border-primary p-6 rounded-lg text-white text-center w-full md:w-auto">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto text-primary mb-3" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <p className="font-bold text-lg text-primary">Thanks for subscribing!</p>
            <p className="text-white mt-1">We'll be in touch soon with valuable insights.</p>
          </div>
        ) : (
